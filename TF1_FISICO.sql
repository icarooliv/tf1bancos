...
CREATE TABLE IF NOT EXISTS VISITA (
    ...
    UNIQUE KEY TIPO_DATAHORAFIM_DATAHORAINICIO_TIPOVISITA_PACIENTE_UN (dataHoraInicio, dataHorafim, idTipoVisita, idPaciente, idCategoriaProfissional, idRegistroProfissional),
